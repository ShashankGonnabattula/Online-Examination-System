    ...
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="glass-panel p-8">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-display font-bold text-gray-100">{exam.title}</h1>
          <div className="glass-panel px-4 py-2 text-sm border border-primary-500/30">
            <span className="text-gray-300">Time left: </span>
            <span className="font-bold text-primary-400">{formatted}</span>
          </div>
        </div>
